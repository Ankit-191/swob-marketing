...
import { FAQS_DATA_LIST } from '../../types/util/helper';
    ...
    <section>
        ...
        <div class="md:bg-white-light py-12 sm:py-14 md:py-16 lg:py-20">
            <div class="container mx-auto px-4 sm:px-5 max-w-[1320px]">
                <h2 class="font-semibold font-sans sm:font-extrabold text-black leading-110 text-center text-[30px] sm:text-4xl md:text-5xl lg:text-6xxl">{{ t(title) }}</h2>
                <div class="flex flex-col gap-6 w-full pt-12 sm:pt-14 md:pt-16 lg:pt-20">
                    <div v-for="(value, index) in FAQS_DATA_LIST" :key="index"
                        ...
                        <button @click="toggleAccordion(index)" class="flex items-center justify-between gap-2.5">
                            <p class="text-black font-sans font-medium text-lg sm:text-xl leading-110">{{ value.title }}?</p>
                        ...
                        <div
                            ...
                            <div class="overflow-hidden">
                                <p class="text-black font-sans text-base sm:text-lg pt-4 pr-5 md:pr-8">{{ value.description }}</p>
                            </div>
                        </div>
                    </div>
                </div>
